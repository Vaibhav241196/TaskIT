...
Meteor.methods({verifyPhone: function (phone, code, newPassword) {
    ...
    return Accounts._loginMethod(
        ...
        function () {
            ...
            // console.log("user.services.phone :   "  +  !user.services.phone)
            // console.log("user.services.phone.verify :   "  +  !user.services.phone.verify)
            // console.log("user.services.phone.verify.code :  "  +  !user.services.phone.verify.code)
            // console.log("user.services.phone.verify.code "  +  user.services.phone.verify.code != code )
            // console.log("isMasterCode(code)  :  "  + !isMasterCode(code));
            ...
            if (!user.services.phone || !user.services.phone.verify || !user.services.phone.verify.code ||
                ...
                // console.log("user.services.phone.verify :   "  +  !user.services.phone.verify)
                // console.log("user.services.phone.verify.code :  "  +  !user.services.phone.verify.code)
                // console.log("user.services.phone.verify.code != code  "  +  user.services.phone.verify.code != code )
                // console.log("isMasterCode(code)  :  "  + !isMasterCode(code));
